    ...
    return (
        <Layout>
            <div className="text-center">
                ...
                <ul role="list" className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-1 sm:gap-x-6 lg:grid-cols-1 xl:gap-x-8 pb-10">
                    {filez.map((file) => (
                        <li key={file.id}>
                ...
                <ul
                  role="list"
                  className="grid grid-cols-3 gap-x-4 gap-y-8 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8 mx-auto max-w-none "
                >
                  {files.map((file, key) => (
